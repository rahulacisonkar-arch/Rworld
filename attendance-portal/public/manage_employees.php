...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!validate_csrf_token($csrf_token)) {
        ...
        if ($action === 'add' || $action === 'edit') {
            ...
            $employment_type = trim($_POST['employment_type'] ?? 'Salaried');
                ...
                <form method="GET" action="manage_employees.php" class="row g-2">
                    ...
                    <div class="col-md-3">
                        <select name="employment_type" class="form-select">
                            ...
                            <option value="Salaried" <?php echo $filterType === 'Salaried' ? 'selected' : ''; ?>>Salaried</option>
                            <option value="Hourly" <?php echo $filterType === 'Hourly' ? 'selected' : ''; ?>>Hourly</option>
                            <option value="Contractual/1099" <?php echo $filterType === 'Contractual/1099' ? 'selected' : ''; ?>>Contractual/1099</option>
                        </select>
                    </div>
                    <div class="col-md-2">
                ...
                <div class="modal-body row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="employment_type" class="form-select">
                            ...
                            <option value="Contractual/1099">Contractual/1099</option>
                        </select>
                    </div>
                    <div class="col-md-4">
