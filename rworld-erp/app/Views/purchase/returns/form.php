<!-- Purchase Return Create Form -->
<div class="page-header d-flex justify-content-between align-items-center">
    <div>
        <h1 class="page-title"><i class="fas fa-reply mr-2 text-danger"></i>New Purchase Return</h1>
        <div class="page-subtitle">Return defective or overstocked inventory to vendor</div>
    </div>
    <a href="<?= APP_URL ?>/purchasereturn" class="btn btn-outline-secondary"><i class="fas fa-arrow-left mr-1"></i> Back</a>
</div>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="qb-card mb-4" style="position:relative">
                <div class="qb-card-header d-flex justify-content-between align-items-center">
                    <span class="qb-card-title">Returned Items</span>
                    ...
                    <table class="qb-table table-sm" id="lineTable">
                        <thead>
                            <tr>
                                ...
                                <th style="width:20%" class="text-right">Return Cost</th>
        ...
        <div class="col-md-4">
            <div class="qb-card mb-4">
                <div class="qb-card-header"><span class="qb-card-title">Vendor Info</span></div>
            ...
            <button type="submit" class="btn btn-danger btn-block" onclick="return prepareSubmit()"><i class="fas fa-save mr-1"></i> Save Purchase Return</button>
        </div>
    </div>
</form>
