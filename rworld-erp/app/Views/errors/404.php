<?php
/**
 * QuickBill POS — 404 Not Found View
...
.code{font-size:80px;font-weight:800;color:#64748b;line-height:1;margin-bottom:16px}
...
<div class="box">
    ...
    <p>The requested page or resource could not be found.<br>
       Please check the URL or return to safety.</p>
