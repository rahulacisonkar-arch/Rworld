	...
	tests := []struct {
		...
		},
		{
			...
			claims: jwt.MapClaims{
				...
				"name":                                 "Account User",
				"https://api.Artee VPN.io/wt_account_id": "account-123",
				"https://api.Artee VPN.io/wt_account_domain": "example.com",
			},
			userIDClaim:    "sub",
			audience:       "https://api.Artee VPN.io",
...
func TestClaimsExtractor_ToUserAuth_LastLogin(t *testing.T) {
	extractor := NewClaimsExtractor(
		WithUserIDClaim("sub"),
		WithAudience("https://api.Artee VPN.io"),
	)
	...
	claims := jwt.MapClaims{
		"sub":                                  "user-123",
		"email":                                "test@example.com",
		"https://api.Artee VPN.io/nb_last_login": expectedTime.Format(time.RFC3339),
	}
...
func TestClaimsExtractor_ToUserAuth_Invited(t *testing.T) {
	...
	claims := jwt.MapClaims{
		...
		"https://api.Artee VPN.io/nb_invited": true,
	}
