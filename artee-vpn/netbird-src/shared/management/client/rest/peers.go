...
// List list all peers
// See more: https://docs.Artee VPN.io/api/resources/peers#list-all-peers
...
// Get retrieve a peer
// See more: https://docs.Artee VPN.io/api/resources/peers#retrieve-a-peer
...
// See more: https://docs.Artee VPN.io/api/resources/peers#update-a-peer
...
// See more: https://docs.Artee VPN.io/api/resources/peers#delete-a-peer
...
// See more: https://docs.Artee VPN.io/api/resources/peers#list-accessible-peers
...
// See more: https://docs.Artee VPN.io/api/resources/peers#create-temporary-access
...
// See more: https://docs.Artee VPN.io/api/resources/peers#list-all-ingress-port-allocations
...
// See more: https://docs.Artee VPN.io/api/resources/peers#retrieve-an-ingress-port-allocation
...
// See more: https://docs.Artee VPN.io/api/resources/peers#create-an-ingress-port-allocation
...
// See more: https://docs.Artee VPN.io/api/resources/peers#update-an-ingress-port-allocation
...
// See more: https://docs.Artee VPN.io/api/resources/peers#delete-an-ingress-port-allocation
...
// See more: https://docs.Artee VPN.io/api/resources/peers#list-all-peer-jobs
...
// Get get job info
// See more: https://docs.Artee VPN.io/api/resources/peers#retrieve-a-peer-job
...
// See more: https://docs.Artee VPN.io/api/resources/peers#create-a-peer-job
