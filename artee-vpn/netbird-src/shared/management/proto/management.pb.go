...
type EncryptedMessage struct {
	...
	// Version of the Artee VPN Management Service protocol
...
// SyncResponse represents a state that should be applied to the local peer (e.g. Artee VPN servers config as well as local peer and remote peers configs)
type SyncResponse struct {
	...
	// Global config
	Artee VPNConfig *Artee VPNConfig `protobuf:"bytes,1,opt,name=Artee VPNConfig,proto3" json:"Artee VPNConfig,omitempty"`
...
func (x *SyncResponse) GetArtee VPNConfig() *Artee VPNConfig {
	if x != nil {
		return x.Artee VPNConfig
	}
	return nil
}
...
type PeerSystemMeta struct {
	...
	Artee VPNVersion   string            `protobuf:"bytes,7,opt,name=Artee VPNVersion,proto3" json:"Artee VPNVersion,omitempty"`
...
func (x *PeerSystemMeta) GetArtee VPNVersion() string {
	if x != nil {
		return x.Artee VPNVersion
	}
	return ""
}
...
func (x *LoginResponse) GetArtee VPNConfig() *Artee VPNConfig {
	if x != nil {
		return x.Artee VPNConfig
	}
	return nil
...
// Artee VPNConfig is a common configuration of any Artee VPN peer. It contains STUN, TURN, Signal and Management servers configurations
type Artee VPNConfig struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Artee VPNConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Artee VPNConfig) ProtoMessage() {}

func (x *Artee VPNConfig) ProtoReflect() protoreflect.Message {
	mi := &file_management_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Artee VPNConfig.ProtoReflect.Descriptor instead.
func (*Artee VPNConfig) Descriptor() ([]byte, []int) {
	return file_management_proto_rawDescGZIP(), []int{19}
}

func (x *Artee VPNConfig) GetStuns() []*HostConfig {
	if x != nil {
		return x.Stuns
	}
	return nil
...
func (x *Artee VPNConfig) GetTurns() []*ProtectedHostConfig {
	if x != nil {
		return x.Turns
	}
	return nil
...
func (x *Artee VPNConfig) GetSignal() *HostConfig {
	if x != nil {
		return x.Signal
	}
	return nil
...
func (x *Artee VPNConfig) GetRelay() *RelayConfig {
	if x != nil {
		return x.Relay
	}
	return nil
...
func (x *Artee VPNConfig) GetFlow() *FlowConfig {
	if x != nil {
		return x.Flow
	}
	return nil
...
type HostConfig struct {
	...
	// URI of the resource e.g. turns://stun.Artee VPN.io:4430 or signal.Artee VPN.io:10000
...
type PeerConfig struct {
	...
	// Peer's virtual IP address within the Artee VPN VPN (a Wireguard address config)
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	// Artee VPN DNS server (a Wireguard DNS config)
...
var file_management_proto_goTypes = []interface{}{
	...
	(*Artee VPNConfig)(nil),                  // 27: management.Artee VPNConfig
...
var file_management_proto_depIdxs = []int32{
	...
	27, // 4: management.SyncResponse.Artee VPNConfig:type_name -> management.Artee VPNConfig
	...
	27, // 18: management.LoginResponse.Artee VPNConfig:type_name -> management.Artee VPNConfig
	...
	28, // 25: management.Artee VPNConfig.stuns:type_name -> management.HostConfig
	32, // 26: management.Artee VPNConfig.turns:type_name -> management.ProtectedHostConfig
	28, // 27: management.Artee VPNConfig.signal:type_name -> management.HostConfig
	29, // 28: management.Artee VPNConfig.relay:type_name -> management.RelayConfig
	30, // 29: management.Artee VPNConfig.flow:type_name -> management.FlowConfig
