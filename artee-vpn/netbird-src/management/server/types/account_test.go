...
func Test_FilterZoneRecordsForPeers(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			customZone: nbdns.CustomZone{
				Domain: "Artee VPN.cloud.",
				Records: []nbdns.SimpleRecord{
					{Name: "peer1.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.1"},
					{Name: "router.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.100"},
				},
			},
			peersToConnect: []*nbpeer.Peer{},
			expiredPeers:   []*nbpeer.Peer{},
				...
				Records: func() []nbdns.SimpleRecord {
					...
					for i := 1; i <= 100; i++ {
						records = append(records, nbdns.SimpleRecord{
							Name:  fmt.Sprintf("peer%d.Artee VPN.cloud", i),
							Type:  int(dns.TypeA),
		...
		},
		{
			...
			customZone: nbdns.CustomZone{
				...
				Records: []nbdns.SimpleRecord{
					{Name: "peer1.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.1"},
					{Name: "peer1-alt.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.1"},
					{Name: "peer1-backup.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.1"},
					{Name: "peer2.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.2"},
					{Name: "peer2-service.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.2"},
					{Name: "peer3.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.3"},
					{Name: "peer3-alt.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.3"},
					{Name: "router.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.100"},
				},
			},
			peersToConnect: []*nbpeer.Peer{
		...
		},
		{
			...
			customZone: nbdns.CustomZone{
				...
				Records: []nbdns.SimpleRecord{
					{Name: "peer1.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.1"},
					{Name: "peer2.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.2"},
					{Name: "expired-peer.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.99"},
					{Name: "router.Artee VPN.cloud", Type: int(dns.TypeA), Class: nbdns.DefaultClass, TTL: 300, RData: "10.0.0.100"},
				},
			},
			peersToConnect: []*nbpeer.Peer{
		...
		Services: []*service.Service{
			{
				...
				AccountID:    "acct-1",
				Name:         "myapp",
				Domain:       "myapp.eu.proxy.Artee VPN.io",
				ProxyCluster: "eu.proxy.Artee VPN.io",
				Enabled:      true,
				Private:      true,
				...
				Targets: []*service.Target{
					{
						TargetId:   "eu.proxy.Artee VPN.io",
