...
const (
	...
	// PolicyRuleProtocolArtee VPNSSH type of traffic
	PolicyRuleProtocolArtee VPNSSH = PolicyRuleProtocolType("Artee VPN-ssh")
)
...
func ParseRuleString(rule string) (PolicyRuleProtocolType, RulePortRange, error) {
	...
	case "Artee VPN-ssh":
		return PolicyRuleProtocolArtee VPNSSH, RulePortRange{Start: nativeSSHPortNumber, End: nativeSSHPortNumber}, nil
	default:
