...
func createRouterManager(t *testing.T) (*DefaultAccountManager, *update_channel.PeersUpdateManager, error) {
	...
	networkMapController := controller.NewController(ctx, store, metrics, updateManager, requestBuffer, MockIntegratedValidator{}, settingsMockManager, "Artee VPN.selfhosted", port_forwarding.NewControllerMock(), ephemeral_manager.NewEphemeralManager(store, peers.NewManager(store, permissionsManager)), &config.Config{})
...
func initTestRouteAccount(t *testing.T, am *DefaultAccountManager) (*types.Account, error) {
	...
	peer1 := &nbpeer.Peer{
		...
		ID:       peer1ID,
		Key:      peer1Key,
		Name:     "test-host1@Artee VPN.io",
		DNSLabel: "test-host1",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host1@Artee VPN.io",
			GoOS:      "linux",
			Kernel:    "Linux",
			Core:      "21.04",
			Platform:  "x86_64",
	...
	peer2 := &nbpeer.Peer{
		...
		ID:       peer2ID,
		Key:      peer2Key,
		Name:     "test-host2@Artee VPN.io",
		DNSLabel: "test-host2",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host2@Artee VPN.io",
			GoOS:      "linux",
			Kernel:    "Linux",
			Core:      "21.04",
			Platform:  "x86_64",
	...
	peer3 := &nbpeer.Peer{
		...
		ID:       peer3ID,
		Key:      peer3Key,
		Name:     "test-host3@Artee VPN.io",
		DNSLabel: "test-host3",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host3@Artee VPN.io",
			GoOS:      "darwin",
			Kernel:    "Darwin",
			Core:      "13.4.1",
			Platform:  "arm64",
	...
	peer4 := &nbpeer.Peer{
		...
		ID:       peer4ID,
		Key:      peer4Key,
		Name:     "test-host4@Artee VPN.io",
		DNSLabel: "test-host4",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host4@Artee VPN.io",
			GoOS:      "linux",
			Kernel:    "Linux",
			Core:      "21.04",
			Platform:  "x86_64",
	...
	peer5 := &nbpeer.Peer{
		...
		ID:       peer5ID,
		Key:      peer5Key,
		Name:     "test-host5@Artee VPN.io",
		DNSLabel: "test-host5",
		UserID:   userID,
		Meta: nbpeer.PeerSystemMeta{
			Hostname:  "test-host5@Artee VPN.io",
			GoOS:      "linux",
			Kernel:    "Linux",
			Core:      "21.04",
			Platform:  "x86_64",
