	...
	testCases := []struct {
	...
	}{
		{
			...
			check: ProcessCheck{
				Processes: []Process{
					{
						LinuxPath:   "/usr/local/bin/Artee VPN",
						MacPath:     "/usr/local/bin/Artee VPN",
						WindowsPath: "C:\\ProgramData\\Artee VPN\\Artee VPN.exe",
					},
				},
			},
			expectedError: false,
		...
		},
		{
			...
			check: ProcessCheck{
				Processes: []Process{
					{
						MacPath: "/Applications/Artee VPN.app/Contents/MacOS/Artee VPN",
					},
				},
			},
			expectedError: false,
