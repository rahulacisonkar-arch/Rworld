...
import (
	...
	nbcontext "github.com/Artee VPNio/Artee VPN/management/server/context"
...
func TestPostureCheckUpdate(t *testing.T) {
	...
	tt := []struct {
				...
				[]byte(`{
					...
					"checks": {
						"process_check": {
							"processes": [
								{ 
									"linux_path": "/usr/local/bin/Artee VPN",
									"mac_path": "/Applications/Artee VPN.app/Contents/MacOS/Artee VPN",
									"windows_path": "C:\\ProgramData\\Artee VPN\\Artee VPN.exe"
								}
							]
						}
					}
				...
				Checks: api.Checks{
					ProcessCheck: &api.ProcessCheck{
						Processes: []api.Process{
							{
								LinuxPath:   str("/usr/local/bin/Artee VPN"),
								MacPath:     str("/Applications/Artee VPN.app/Contents/MacOS/Artee VPN"),
								WindowsPath: str("C:\\ProgramData\\Artee VPN\\Artee VPN.exe"),
							},
						},
					},
				},
		...
		{
			name:        "Create Posture Checks Invalid Artee VPN's Min Version",
			requestType: http.MethodPost,
			requestPath: "/api/posture-checks",
			requestBody: bytes.NewBuffer(
				[]byte(`{
		...
		{
			name:        "Update Posture Checks Invalid Artee VPN's Min Version",
			requestType: http.MethodPut,
			requestPath: "/api/posture-checks/postureCheck",
			requestBody: bytes.NewBuffer(
				[]byte(`{
