...
import (
	...
	"github.com/Artee VPNio/Artee VPN/management/internals/modules/reverseproxy/domain/manager"

	"github.com/Artee VPNio/Artee VPN/management/server/types"

	"github.com/Artee VPNio/Artee VPN/management/internals/modules/reverseproxy/accesslogs"
	"github.com/Artee VPNio/Artee VPN/management/internals/modules/reverseproxy/proxytoken"
	"github.com/Artee VPNio/Artee VPN/management/internals/modules/reverseproxy/service"
	reverseproxymanager "github.com/Artee VPNio/Artee VPN/management/internals/modules/reverseproxy/service/manager"

	nbgrpc "github.com/Artee VPNio/Artee VPN/management/internals/shared/grpc"
	idpmanager "github.com/Artee VPNio/Artee VPN/management/server/idp"

	"github.com/Artee VPNio/Artee VPN/management/internals/controllers/network_map"
	"github.com/Artee VPNio/Artee VPN/management/internals/modules/zones"
	zonesManager "github.com/Artee VPNio/Artee VPN/management/internals/modules/zones/manager"
	"github.com/Artee VPNio/Artee VPN/management/internals/modules/zones/records"
	recordsManager "github.com/Artee VPNio/Artee VPN/management/internals/modules/zones/records/manager"
	...
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/proxy"

	"github.com/Artee VPNio/Artee VPN/management/server/auth"
	"github.com/Artee VPNio/Artee VPN/management/server/geolocation"
	nbgroups "github.com/Artee VPNio/Artee VPN/management/server/groups"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/accounts"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/dns"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/events"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/groups"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/idp"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/instance"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/networks"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/peers"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/policies"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/routes"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/setup_keys"
	"github.com/Artee VPNio/Artee VPN/management/server/http/handlers/users"
	"github.com/Artee VPNio/Artee VPN/management/server/http/middleware"
	"github.com/Artee VPNio/Artee VPN/management/server/http/middleware/bypass"
	nbinstance "github.com/Artee VPNio/Artee VPN/management/server/instance"
	nbnetworks "github.com/Artee VPNio/Artee VPN/management/server/networks"
	"github.com/Artee VPNio/Artee VPN/management/server/networks/resources"
	"github.com/Artee VPNio/Artee VPN/management/server/networks/routers"
