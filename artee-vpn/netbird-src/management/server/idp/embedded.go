...
const (
	staticClientDashboard         = "Artee VPN-dashboard"
	staticClientCLI               = "Artee VPN-cli"
...
type EmbeddedIdPConfig struct {
	...
	Enabled bool
	// Issuer is the OIDC issuer URL (e.g., "https://management.Artee VPN.io/oauth2")
	Issuer string
