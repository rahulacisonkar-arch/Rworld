...
const (
	// Version endpoints
	managementVersionURL = "https://pkgs.Artee VPN.io/releases/latest/version"
	dashboardReleasesURL = "https://api.github.com/repos/Artee VPNio/dashboard/releases/latest"
...
// VersionInfo contains version information for Artee VPN components
...
type Manager interface {
	...
	// GetVersionInfo returns version information for Artee VPN components.
...
func (m *DefaultManager) loadSetupRequired(ctx context.Context) error {
	// Check if there are any accounts in the Artee VPN store
...
func (m *DefaultManager) fetchVersionInfo(ctx context.Context) (*VersionInfo, error) {
	...
	info := &VersionInfo{
		CurrentVersion: version.Artee VPNVersion(),
	}

	// Fetch management version from pkgs.Artee VPN.io (plain text)
...
func (m *DefaultManager) fetchPlainTextVersion(ctx context.Context, url string) (string, error) {
	...
	req.Header.Set("User-Agent", "Artee VPN-Management/"+version.Artee VPNVersion())
