...
import (
	...
	rpproxy "github.com/Artee VPNio/Artee VPN/management/internals/modules/reverseproxy/proxy"
)
...
func TestSqlStore_GetProxyClusters_DerivesOnlineAndType(t *testing.T) {
	...
	runTestForAllEngines(t, "", func(t *testing.T, store Store) {
		...
		mustSave("p-shared-fresh", "shared-mixed.Artee VPN.io", nil, rpproxy.StatusConnected, fresh)
		mustSave("p-shared-stale", "shared-mixed.Artee VPN.io", nil, rpproxy.StatusConnected, stale)
		...
		mustSave("p-shared-off", "shared-offline.Artee VPN.io", nil, rpproxy.StatusConnected, stale)
		...
		require.Contains(t, byAddr, "shared-mixed.Artee VPN.io")
		mixed := byAddr["shared-mixed.Artee VPN.io"]
		...
		require.Contains(t, byAddr, "shared-offline.Artee VPN.io",
		...
		offline := byAddr["shared-offline.Artee VPN.io"]
