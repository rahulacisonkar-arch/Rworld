...
func TestExtractClusterFromFreeDomain(t *testing.T) {
	clusters := []string{"eu1.proxy.Artee VPN.io", "us1.proxy.Artee VPN.io"}
	...
	tests := []struct {
	...
	}{
		{
			...
			domain:  "myapp.eu1.proxy.Artee VPN.io",
			wantOK:  true,
			wantVal: "eu1.proxy.Artee VPN.io",
		},
		{
			name:    "deep subdomain of cluster matches",
			domain:  "foo.bar.eu1.proxy.Artee VPN.io",
			wantOK:  true,
			wantVal: "eu1.proxy.Artee VPN.io",
		},
		{
		...
		},
		{
			...
			domain: "fakeu1.proxy.Artee VPN.io",
			wantOK: false,
		},
		{
			name:    "second cluster matches",
			domain:  "app.us1.proxy.Artee VPN.io",
			wantOK:  true,
			wantVal: "us1.proxy.Artee VPN.io",
		},
	}
...
func TestExtractClusterFromCustomDomains(t *testing.T) {
	customDomains := []*domain.Domain{
		{Domain: "example.com", TargetCluster: "eu1.proxy.Artee VPN.io"},
		{Domain: "proxy.corp.io", TargetCluster: "us1.proxy.Artee VPN.io"},
	}
