...
import (
	...
	"github.com/Artee VPNio/Artee VPN/shared/management/client/common"
	...
	internalStatus "github.com/Artee VPNio/Artee VPN/shared/management/status"
)
...
func (s *Server) prepareLoginResponse(ctx context.Context, peer *nbpeer.Peer, network *types.Network, postureChecks []*posture.Checks, enableSSH bool) (*proto.LoginResponse, error) {
	...
	loginResp := &proto.LoginResponse{
		Artee VPNConfig: toArtee VPNConfig(s.config, nil, relayToken, nil),
