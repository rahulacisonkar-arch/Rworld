...
import (
	...
	"github.com/Artee VPNio/Artee VPN/management/internals/server"
	nbconfig "github.com/Artee VPNio/Artee VPN/management/internals/server/config"
	nbdomain "github.com/Artee VPNio/Artee VPN/shared/management/domain"
...
var (
	...
	mgmtCmd = &cobra.Command{
		Use:   "management",
		Short: "start Artee VPN Management Server",
...
func ApplyEmbeddedIdPConfig(ctx context.Context, cfg *nbconfig.Config) error {
	...
	cfg.HttpConfig.AuthAudience = "Artee VPN-dashboard"
	cfg.HttpConfig.AuthClientID = cfg.HttpConfig.AuthAudience
	cfg.HttpConfig.CLIAuthAudience = "Artee VPN-cli"
...
func handleRebrand(cmd *cobra.Command) error {
	...
	if nbconfig.MgmtConfigPath == defaultMgmtConfig {
		if migrateToArtee VPN(oldDefaultMgmtConfig, defaultMgmtConfig) {
	...
	if mgmtDataDir == defaultMgmtDataDir {
		if migrateToArtee VPN(oldDefaultMgmtDataDir, defaultMgmtDataDir) {
