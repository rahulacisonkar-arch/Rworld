...
// This allows Dex to use the same log format as the rest of Artee VPN.
...
// NewLogrusHandler creates a new slog handler that wraps logrus with Artee VPN's text formatter.
