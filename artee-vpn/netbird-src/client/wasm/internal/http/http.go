...
// performRequest executes an HTTP request through Artee VPN and returns the response and body
func performRequest(nbClient *Artee VPN.Client, method, url string, headers map[string]string, body []byte) (*http.Response, []byte, error) {
...
// ProxyRequest performs a proxied HTTP request through Artee VPN and returns a JavaScript object
func ProxyRequest(nbClient *Artee VPN.Client, request js.Value) (js.Value, error) {
