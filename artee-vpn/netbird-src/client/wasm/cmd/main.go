...
import (
	...
	Artee VPN "github.com/Artee VPNio/Artee VPN/client/embed"
	sshdetection "github.com/Artee VPNio/Artee VPN/client/ssh/detection"
	nbstatus "github.com/Artee VPNio/Artee VPN/client/status"
	wasmcapture "github.com/Artee VPNio/Artee VPN/client/wasm/internal/capture"
	"github.com/Artee VPNio/Artee VPN/client/wasm/internal/http"
	"github.com/Artee VPNio/Artee VPN/client/wasm/internal/rdp"
	"github.com/Artee VPNio/Artee VPN/client/wasm/internal/ssh"
	nbwebsocket "github.com/Artee VPNio/Artee VPN/client/wasm/internal/websocket"
...
func main() {
	js.Global().Set("Artee VPNClient", js.FuncOf(Artee VPNClientConstructor))

	select {}
}

func startClient(ctx context.Context, nbClient *Artee VPN.Client) error {
	log.Info("Starting Artee VPN client...")
	if err := nbClient.Start(ctx); err != nil {
		return err
	}
	log.Info("Artee VPN client started successfully")
	return nil
}

// parseClientOptions extracts Artee VPN options from JavaScript object
func parseClientOptions(jsOptions js.Value) (Artee VPN.Options, error) {
	options := Artee VPN.Options{
...
func createStartMethod(client *Artee VPN.Client) js.Func {
...
func createStopMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(this js.Value, args []js.Value) any {
		return createPromise(func(resolve, reject js.Value) {
			...
			log.Info("Artee VPN client stopped")
			resolve.Invoke(js.ValueOf(true))
		})
	})
}
...
func createSSHMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(this js.Value, args []js.Value) any {
...
func connectSSH(client *Artee VPN.Client, host string, port int, username, jwtToken string, ipVersion int) (js.Value, error) {
...
func performPing(client *Artee VPN.Client, hostname string, ipVersion int) {
...
func performPingTCP(client *Artee VPN.Client, hostname string, port, ipVersion int) {
	ctx, cancel := context.WithTimeout(context.Background(), pingTimeout)
	defer cancel()
...
func createPingMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(this js.Value, args []js.Value) any {
		if len(args) < 1 {
...
func createPingTCPMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(this js.Value, args []js.Value) any {
		if len(args) < 2 {
...
func createProxyRequestMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(this js.Value, args []js.Value) any {
		if len(args) < 1 {
...
func createRDPProxyMethod(client *Artee VPN.Client) js.Func {
...
func getStatusOverview(client *Artee VPN.Client) (nbstatus.OutputOverview, error) {
...
func createStatusMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(_ js.Value, args []js.Value) any {
		return createPromise(func(resolve, reject js.Value) {
...
func createStatusSummaryMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(_ js.Value, args []js.Value) any {
		return createPromise(func(resolve, reject js.Value) {
			overview, err := getStatusOverview(client)
			if err != nil {
...
func createStatusDetailMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(_ js.Value, args []js.Value) any {
		return createPromise(func(resolve, reject js.Value) {
			overview, err := getStatusOverview(client)
			if err != nil {
...
func createGetSyncResponseMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(_ js.Value, args []js.Value) any {
		return createPromise(func(resolve, reject js.Value) {
...
func createSetLogLevelMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(_ js.Value, args []js.Value) any {
		if len(args) < 1 {
...
func createStartCaptureMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(_ js.Value, args []js.Value) any {
		var opts js.Value
		if len(args) > 0 {
			opts = args[0]
...
func captureMethods(client *Artee VPN.Client) (startFn, stopFn js.Func) {
	var mu sync.Mutex
...
func createDetectSSHServerMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(this js.Value, args []js.Value) any {
		if len(args) < 2 {
...
// createClientObject wraps the Artee VPN client in a JavaScript object
func createClientObject(client *Artee VPN.Client) js.Value {
...
func createDialWebSocketMethod(client *Artee VPN.Client) js.Func {
	return js.FuncOf(func(_ js.Value, args []js.Value) any {
...
// Artee VPNClientConstructor acts as a JavaScript constructor function
func Artee VPNClientConstructor(_ js.Value, args []js.Value) any {
	return js.Global().Get("Promise").New(js.FuncOf(func(_ js.Value, promiseArgs []js.Value) any {
		resolve := promiseArgs[0]
		reject := promiseArgs[1]
		...
		go func() {
			...
			log.Infof("Creating Artee VPN client with options: deviceName=%s, hasJWT=%v, hasSetupKey=%v, mgmtURL=%s",
				options.DeviceName, options.JWTToken != "", options.SetupKey != "", options.ManagementURL)

			client, err := Artee VPN.New(options)
			if err != nil {
			...
			log.Info("Artee VPN client created successfully")
