...
const (
	Artee VPNSSHConfigFile = "99-Artee VPN.conf"
...
// DaemonHostKeyVerifier implements HostKeyVerifier using the Artee VPN daemon
...
// VerifySSHHostKey verifies an SSH host key by querying the Artee VPN daemon
