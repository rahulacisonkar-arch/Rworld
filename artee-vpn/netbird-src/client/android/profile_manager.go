...
const (
	...
	defaultConfigFilename = "Artee VPN.cfg"
...
/data/data/io.Artee VPN.client/files/           ← configDir parameter
├── Artee VPN.cfg                                 ← Default profile config
...
// This is needed for Android-specific path handling (Artee VPN.cfg for default profile)
func (pm *ProfileManager) getProfileConfigPath(id string) (string, error) {
	...
	if id == profilemanager.DefaultProfileName {
		// Android uses Artee VPN.cfg for default profile instead of default.json
