...
import (
	...
	"github.com/Artee VPNio/Artee VPN/client/system/detect_cloud"
	"github.com/Artee VPNio/Artee VPN/client/system/detect_platform"
...
func GetInfo(ctx context.Context) *Info {
	...
	return &Info{
		...
		CPUs:             runtime.NumCPU(),
		Artee VPNVersion:   version.Artee VPNVersion(),
