...
const (
	...
	chainNameInputRules = "Artee VPN-acl-input-rules"

	// filter chains contains the rules that jump to the rules chains
	chainNameInputFilter       = "Artee VPN-acl-input-filter"
	chainNameForwardFilter     = "Artee VPN-acl-forward-filter"
	chainNameManglePrerouting  = "Artee VPN-mangle-prerouting"
	chainNameManglePostrouting = "Artee VPN-mangle-postrouting"
)
...
func (m *AclManager) createDefaultChains() (err error) {
	...
	// Artee VPN-acl-input-filter
	// type filter hook input priority filter; policy accept;
	chain = m.createFilterChainWithHook(chainNameInputFilter, nftables.ChainHookInput)
	m.addJumpRule(chain, m.chainInputRules.Name, expr.MetaKeyIIFNAME) // to Artee VPN-acl-input-rules
