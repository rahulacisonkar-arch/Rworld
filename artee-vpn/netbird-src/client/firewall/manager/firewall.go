...
const (
	ForwardingFormatPrefix = "Artee VPN-fwd-"
	ForwardingFormat       = "Artee VPN-fwd-%s-%t"
	PreroutingFormat       = "Artee VPN-prerouting-%s-%t"
	NatFormat              = "Artee VPN-nat-%s-%t"
)
...
type Manager interface {
	...
	// AddDNATRule adds outbound DNAT rule for forwarding external traffic to the Artee VPN network.
