...
import (
	...
	nbiptables "github.com/Artee VPNio/Artee VPN/client/firewall/iptables"
	firewall "github.com/Artee VPNio/Artee VPN/client/firewall/manager"
	nbnftables "github.com/Artee VPNio/Artee VPN/client/firewall/nftables"
...
func createUserspaceFirewall(iface IFaceMapper, fm firewall.Manager, disableServerRoutes bool, flowLogger nftypes.FlowLogger, mtu uint16) (firewall.Manager, error) {
	...
	if err := fm.AllowArtee VPN(); err != nil {
		log.Errorf("failed to allow Artee VPN interface traffic: %v", err)
	}
	return fm, nil
}
