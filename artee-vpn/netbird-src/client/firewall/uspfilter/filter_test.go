...
import (
	...
	fw "github.com/Artee VPNio/Artee VPN/client/firewall/manager"
	"github.com/Artee VPNio/Artee VPN/client/firewall/uspfilter/conntrack"
	"github.com/Artee VPNio/Artee VPN/client/firewall/uspfilter/log"
	nbiface "github.com/Artee VPNio/Artee VPN/client/iface"
...
func TestShouldForward(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			dstIP:           otherIP,
			expected:        true,
			description:     "should forward traffic to our other local interfaces (not Artee VPN IP)",
		},
		{
			name:            "traffic to Artee VPN IP, no netstack",
			localForwarding: true,
			netstack:        false,
			dstIP:           wgIP,
			expected:        false,
