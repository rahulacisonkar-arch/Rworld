...
import (
	...
	"github.com/Artee VPNio/Artee VPN/client/iface/wgproxy/ebpf"
	"github.com/Artee VPNio/Artee VPN/client/iface/wgproxy/udp"
)
...
func TestRedirectAs_eBPF_IPv4(t *testing.T) {
	...
	// Artee VPN UDP address of the remote peer
	nbAddr := &net.UDPAddr{
...
func testRedirectAs(t *testing.T, proxy Proxy, wgPort int, nbAddr, p2pEndpoint *net.UDPAddr) {
	...
	// Determine which listener to use based on the Artee VPN address IP version
