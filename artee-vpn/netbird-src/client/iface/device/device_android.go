...
func (t *WGTunDevice) Create(routes []string, dns string, searchDomains []string) (WGConfigurer, error) {
	...
	t.device = device.NewDevice(t.filteredDevice, t.iceBind, device.NewLogger(wgLogLevel(), "[Artee VPN] "))
	// without this property mobile devices can discover remote endpoints if the configured one was wrong.
	// this helps with support for the older Artee VPN clients that had a hardcoded direct mode
