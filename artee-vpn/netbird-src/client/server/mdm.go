...
func (s *Server) onMDMPolicyChange(_, _ *mdm.Policy) error {
	...
	s.statusRecorder.PublishEvent(
		...
		"MDM policy applied",
		"Artee VPN configuration was updated by your IT policy.",
...
// `Artee VPN up` (see setupSetConfigReq in cmd/up.go) — a plain
// `Artee VPN up` produces a request with every field at its zero value;
