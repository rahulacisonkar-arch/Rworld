...
func TestSetConfig_AllFieldsSaved(t *testing.T) {
	...
	req := &proto.SetConfigRequest{
		...
		Username:              currUser.Username,
		ManagementUrl:         "https://new-api.Artee VPN.io:443",
		AdminURL:              "https://new-admin.Artee VPN.io",
	...
	require.Equal(t, "https://new-api.Artee VPN.io:443", cfg.ManagementURL.String())
	require.Equal(t, "https://new-admin.Artee VPN.io:443", cfg.AdminURL.String())
