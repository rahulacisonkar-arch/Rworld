...
// policyRegistryPath is the well-known MDM policy registry key for Artee VPN.
...
// Listed in the project's docs/mdm/Artee VPN.admx schema.
const policyRegistryPath = `Software\Policies\Artee VPN`
...
// Windows registry under HKLM\Software\Policies\Artee VPN. Returns:
//   - (nil, nil)  when the key is absent (device not MDM-enrolled for Artee VPN)
