...
// device-level mandatory MDM payload for Artee VPN. The path is fixed by
...
// bundle id io.Artee VPN.client, the OS materializes the payload here.
//
...
const policyPlistPath = "/Library/Managed Preferences/io.Artee VPN.client.plist"
...
//     Artee VPN, or admin has not yet pushed a payload)
...
func loadPlatformPolicy() (map[string]any, error) {
	...
	if err != nil {
		if errors.Is(err, fs.ErrNotExist) {
			// Not enrolled for Artee VPN. Caller treats nil as
