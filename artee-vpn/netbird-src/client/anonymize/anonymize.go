...
func (a *Anonymizer) AnonymizeDomain(domain string) string {
	...
	if strings.HasSuffix(baseDomain, "Artee VPN.io") ||
		strings.HasSuffix(baseDomain, "Artee VPN.selfhosted") ||
		strings.HasSuffix(baseDomain, "Artee VPN.cloud") ||
		strings.HasSuffix(baseDomain, "Artee VPN.stage") ||
