...
import (
	...
	probeRelay "github.com/Artee VPNio/Artee VPN/client/internal/relay"
...
// DaemonStatus represents the current state of the Artee VPN daemon.
...
type PeerStateDetailOutput struct {
	...
	IP                     string           `json:"Artee VPNIp" yaml:"Artee VPNIp"`
	IPv6                   string           `json:"Artee VPNIpv6,omitempty" yaml:"Artee VPNIpv6,omitempty"`
...
func (o *OutputOverview) GeneralSummary(showURL bool, showRelays bool, showNameServers bool, showSSHSessions bool) string {
	...
	ipv6Line := ""
	if o.IPv6 != "" {
		ipv6Line = fmt.Sprintf("Artee VPN IPv6: %s\n", o.IPv6)
	}
