	...
	expectedJSONString := `
        {
          "peers": {
            ...
            "details": [
              {
                "fqdn": "peer-1.awesome-domain.com",
                "Artee VPNIp": "192.168.178.101",
                "Artee VPNIpv6": "fd00::1",
                "publicKey": "Pubkey1",
                "status": "Connected",
          ...
          "Artee VPNIp": "192.168.178.100/16",
          "Artee VPNIpv6": "fd00::100",
...
func TestParsingToDetail(t *testing.T) {
 ...
 peer-1.awesome-domain.com:
  Artee VPN IP: 192.168.178.101
  Artee VPN IPv6: fd00::1
  Public key: Pubkey1
  Status: Connected
  -- detail --
  Connection type: P2P
...
FQDN: some-localhost.awesome-domain.com
Artee VPN IP: 192.168.178.100/16
Artee VPN IPv6: fd00::100
