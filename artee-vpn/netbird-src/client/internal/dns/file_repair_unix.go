...
// nbParamsAreMissing checks if the resolv.conf file contains all the parameters that Artee VPN needs
// check the Artee VPN related nameserver IP at the first place
// check the Artee VPN related search domains in the search domains list
