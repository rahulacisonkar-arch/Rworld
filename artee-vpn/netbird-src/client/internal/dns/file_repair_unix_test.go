...
nameserver 10.0.0.1
nameserver 8.8.8.8
searchdomain Artee VPN.cloud something`,
...
nameserver 10.0.0.1
nameserver 8.8.8.8
searchdomain Artee VPN.cloud something somethingelse`,
			wantChange: false,
		},
		{
			resolvConfContent: `
...
nameserver 8.8.8.8`,
	...
	for _, tt := range tests {
		...
		t.Run("test", func(t *testing.T) {
			...
			r.watchFileChanges([]string{"Artee VPN.cloud"}, netip.MustParseAddr("10.0.0.1"), nil)
