...
func TestLocalResolver_ServeDNS(t *testing.T) {
	...
	recordCNAME := nbdns.SimpleRecord{
		Name:  "peerb.Artee VPN.cloud.",
		Type:  5,
		Class: nbdns.DefaultClass,
		TTL:   300,
		RData: "www.Artee VPN.io",
	}

	wild := "wild.Artee VPN.cloud."
...
func TestLocalResolver_NoErrorWithDifferentRecordType(t *testing.T) {
	...
	resolver.Update([]nbdns.CustomZone{{Domain: "Artee VPN.cloud.", Records: []nbdns.SimpleRecord{recordA, recordCNAME}}})
	...
	testCases := []struct {
	...
	}{
		{
			...
			queryName:      "example.Artee VPN.cloud.",
			queryType:      dns.TypeA,
		...
		},
		{
			...
			queryName:      "alias.Artee VPN.cloud.",
			queryType:      dns.TypeA,
			expectedRcode:  dns.RcodeSuccess,
			shouldHaveData: true,
		},
		...
		},
		{
			...
			queryName:      "nonexistent.Artee VPN.cloud.",
			queryType:      dns.TypeA,
...
func BenchmarkFindZone_TypicalCase(b *testing.B) {
	...
	resolver.Update([]nbdns.CustomZone{
		{Domain: "Artee VPN.cloud.", NonAuthoritative: false},
