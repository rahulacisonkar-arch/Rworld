...
import (
	...
	"github.com/Artee VPNio/Artee VPN/client/firewall"
	"github.com/Artee VPNio/Artee VPN/client/firewall/firewalld"
	firewallManager "github.com/Artee VPNio/Artee VPN/client/firewall/manager"
	"github.com/Artee VPNio/Artee VPN/client/firewall/uspfilter/forwarder"
	"github.com/Artee VPNio/Artee VPN/client/iface"
	"github.com/Artee VPNio/Artee VPN/client/iface/device"
	nbnetstack "github.com/Artee VPNio/Artee VPN/client/iface/netstack"
	"github.com/Artee VPNio/Artee VPN/client/iface/udpmux"
	"github.com/Artee VPNio/Artee VPN/client/iface/wgaddr"
	"github.com/Artee VPNio/Artee VPN/client/internal/acl"
	"github.com/Artee VPNio/Artee VPN/client/internal/debug"
	"github.com/Artee VPNio/Artee VPN/client/internal/dns"
	dnsconfig "github.com/Artee VPNio/Artee VPN/client/internal/dns/config"
	"github.com/Artee VPNio/Artee VPN/client/internal/dnsfwd"
	"github.com/Artee VPNio/Artee VPN/client/internal/expose"
	"github.com/Artee VPNio/Artee VPN/client/internal/ingressgw"
	"github.com/Artee VPNio/Artee VPN/client/internal/metrics"
	"github.com/Artee VPNio/Artee VPN/client/internal/netflow"
	nftypes "github.com/Artee VPNio/Artee VPN/client/internal/netflow/types"
	"github.com/Artee VPNio/Artee VPN/client/internal/networkmonitor"
	"github.com/Artee VPNio/Artee VPN/client/internal/peer"
	"github.com/Artee VPNio/Artee VPN/client/internal/peer/guard"
	icemaker "github.com/Artee VPNio/Artee VPN/client/internal/peer/ice"
	"github.com/Artee VPNio/Artee VPN/client/internal/peerstore"
	"github.com/Artee VPNio/Artee VPN/client/internal/portforward"
	"github.com/Artee VPNio/Artee VPN/client/internal/profilemanager"
	"github.com/Artee VPNio/Artee VPN/client/internal/relay"
	"github.com/Artee VPNio/Artee VPN/client/internal/rosenpass"
	...
	"github.com/Artee VPNio/Artee VPN/client/internal/syncstore"
	"github.com/Artee VPNio/Artee VPN/client/internal/updater"
	"github.com/Artee VPNio/Artee VPN/client/jobexec"
	...
	auth "github.com/Artee VPNio/Artee VPN/shared/relay/auth/hmac"
	...
	sProto "github.com/Artee VPNio/Artee VPN/shared/signal/proto"
	"github.com/Artee VPNio/Artee VPN/util"
	"github.com/Artee VPNio/Artee VPN/util/capture"
...
type EngineConfig struct {
	...
	// WgAddr is the Wireguard local address (Artee VPN Network IP).
...
func (e *Engine) Stop() error {
	if e == nil {
		// this seems to be a very odd case but there was the possibility if the Artee VPN down command comes before the engine is fully started
	...
	log.Infof("stopped Artee VPN Engine")
...
func (e *Engine) Start(Artee VPNConfig *mgmProto.Artee VPNConfig, mgmtURL *url.URL) (err error) {
	e.syncMsgMux.Lock()
	...
	// Populate DNS cache with Artee VPNConfig and management URL for early resolution
	if err := e.PopulateArtee VPNConfig(Artee VPNConfig, mgmtURL); err != nil {
...
// PopulateArtee VPNConfig populates the DNS cache with infrastructure domains from login response
func (e *Engine) PopulateArtee VPNConfig(Artee VPNConfig *mgmProto.Artee VPNConfig, mgmtURL *url.URL) error {
	if e.dnsServer == nil {
		return nil
	}
	...
	// Populate Artee VPNConfig domains if provided
	if Artee VPNConfig != nil {
		serverDomains := dnsconfig.ExtractFromArtee VPNConfig(Artee VPNConfig)
		if err := e.dnsServer.UpdateServerConfig(serverDomains); err != nil {
			return fmt.Errorf("update DNS server config from Artee VPNConfig: %w", err)
		}
	}
...
func (e *Engine) handleSync(update *mgmProto.SyncResponse) error {
	...
	if err := e.updateArtee VPNConfig(update.GetArtee VPNConfig()); err != nil {
		return err
	}
...
// updateArtee VPNConfig applies the management-provided Artee VPN configuration:
...
func (e *Engine) updateArtee VPNConfig(wCfg *mgmProto.Artee VPNConfig) error {
	if wCfg == nil {
		return nil
	}
	...
	if err := e.PopulateArtee VPNConfig(wCfg, nil); err != nil {
...
func (e *Engine) handleBundle(params *mgmProto.BundleParameters) (*mgmProto.JobResponse_Bundle, error) {
	...
	bundleDeps := debug.GeneratorDependencies{
		...
		DaemonVersion:  version.Artee VPNVersion(),
		RefreshStatus: func() {
...
func (e *Engine) close() {
	...
	log.Debugf("removing Artee VPN interface %s", e.config.WgIfaceName)

	if e.wgInterface != nil {
		if err := e.wgInterface.Close(); err != nil {
			log.Errorf("failed closing Artee VPN interface %s %v", e.config.WgIfaceName, err)
		}
		e.wgInterface = nil
...
func convertToOfferAnswer(msg *sProto.Message) (*peer.OfferAnswer, error) {
	...
	offerAnswer := peer.OfferAnswer{
		...
		Version:         msg.GetBody().GetArtee VPNVersion(),
