...
import (
	...
	"github.com/Artee VPNio/Artee VPN/client/internal/peer/conntype"
	"github.com/Artee VPNio/Artee VPN/client/internal/peer/dispatcher"
	...
	"github.com/Artee VPNio/Artee VPN/client/internal/peer/worker"
...
func (conn *Conn) presharedKey(remoteRosenpassKey []byte) *wgtypes.Key {
	...
	// Use Artee VPN PSK as the seed for Rosenpass. This same PSK is passed to
	...
	// Fallback to deterministic key if no Artee VPN PSK is configured
