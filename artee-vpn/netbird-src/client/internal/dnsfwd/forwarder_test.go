...
func TestDNSForwarder_UpstreamFailureEDE(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			reqEdns:     true,
			wantEDE:     true,
			wantCode:    edeArtee VPNUpstreamTimeout,
			wantTextHas: "Artee VPN forwarder: upstream timeout",
		},
		{
			...
			reqEdns:     true,
			wantEDE:     true,
			wantCode:    edeArtee VPNUpstreamFailure,
			wantTextHas: "Artee VPN forwarder: upstream failure",
		},
		{
