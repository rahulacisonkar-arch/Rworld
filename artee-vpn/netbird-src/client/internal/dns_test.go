...
func TestCreatePTRRecord_IPv4(t *testing.T) {
	...
	assert.Equal(t, "peer1.Artee VPN.cloud.", ptr.RData)
}
		...
		CustomZones: []nbdns.CustomZone{
			{
				...
				Records: []nbdns.SimpleRecord{
					{Name: "peer1.Artee VPN.cloud.", Type: int(dns.TypeA), RData: "100.64.0.1"},
					{Name: "peer1.Artee VPN.cloud.", Type: int(dns.TypeAAAA), RData: "fd00::1"},
					{Name: "peer2.Artee VPN.cloud.", Type: int(dns.TypeA), RData: "100.64.0.2"},
				},
			},
		},
	}
		...
		CustomZones: []nbdns.CustomZone{
			{
				Domain: "Artee VPN.cloud.",
				Records: []nbdns.SimpleRecord{
					{Name: "peer1.Artee VPN.cloud.", Type: int(dns.TypeAAAA), RData: "fd00:1234:5678::1"},
				},
			},
		},
	}
