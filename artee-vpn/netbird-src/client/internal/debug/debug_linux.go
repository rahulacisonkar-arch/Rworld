...
// getServiceName gets the service name from environment or defaults to Artee VPN
...
// addSysctls collects forwarding and Artee VPN-managed sysctl values and writes them to the bundle.
...
// collectSysctls reads every sysctl that the Artee VPN client may modify, plus
