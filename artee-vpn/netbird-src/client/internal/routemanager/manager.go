...
import (
	...
	"github.com/Artee VPNio/Artee VPN/client/internal/routemanager/client"
	"github.com/Artee VPNio/Artee VPN/client/internal/routemanager/common"
	...
	"github.com/Artee VPNio/Artee VPN/client/internal/routemanager/notifier"
	"github.com/Artee VPNio/Artee VPN/client/internal/routemanager/refcounter"
	"github.com/Artee VPNio/Artee VPN/client/internal/routemanager/server"
	...
	"github.com/Artee VPNio/Artee VPN/client/internal/routeselector"
...
func isRouteSupported(route *route.Route) bool {
	...
	if route.Network.Bits() <= vars.MinRangeBits {
		log.Warnf("This agent version: %s, doesn't support default routes, received %s, skipping this prefix",
			version.Artee VPNVersion(), route.Network)
		return false
	}
	return true
}
