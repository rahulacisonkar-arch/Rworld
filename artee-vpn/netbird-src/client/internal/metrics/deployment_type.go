...
// DeploymentType represents the type of Artee VPN deployment
...
const (
	...
	// DeploymentTypeCloud represents a cloud-hosted Artee VPN deployment
	DeploymentTypeCloud

	// DeploymentTypeSelfHosted represents a self-hosted Artee VPN deployment
...
func DetermineDeploymentType(managementURL string) DeploymentType {
	...
	if strings.ToLower(u.Hostname()) == "api.Artee VPN.io" {
