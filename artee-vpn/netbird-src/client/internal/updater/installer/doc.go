// Package installer provides functionality for managing Artee VPN application
...
//
//  1. Service Process: The main Artee VPN daemon process that initiates updates
...
//     - macOS Homebrew: brew upgrade Artee VPNio/tap/Artee VPN
...
//     - Windows: Artee VPN.exe service start
//     - macOS/Linux: Artee VPN service start
//  7. Updater restarts UI:
//     - Windows: Launches Artee VPN-ui.exe as active console user using CreateProcessAsUser
//     - macOS: Uses launchctl asuser to launch Artee VPN.app for console user
...
//
// Windows:
//   - Path: %ProgramData%\Artee VPN\tmp-install
//   - Example: C:\ProgramData\Artee VPN\tmp-install
//
// macOS:
//   - Path: /var/lib/Artee VPN/tmp-install
...
//		  Artee VPN_installer_*.[exe|msi|pkg] # Downloaded installer
...
//	Artee VPN service install-update 0.29.0
package installer
