...
const (
	uninstallKeyPath64 = `SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Uninstall\Artee VPN`
	uninstallKeyPath32 = `SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Artee VPN`
)
...
func TypeOfInstaller(_ context.Context) Type {
	...
	log.Debug("No registry entry found for Artee VPN, assuming MSI installation")
	return TypeMSI
}
