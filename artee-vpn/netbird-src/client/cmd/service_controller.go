...
func (p *program) Start(svc service.Service) error {
	...
	log.Info("starting Artee VPN service") //nolint
...
func (p *program) Stop(srv service.Service) error {
	...
	log.Info("stopped Artee VPN service") //nolint
	return nil
}
...
var runCmd = &cobra.Command{
	Use:   "run",
	Short: "runs Artee VPN as service",
...
var startCmd = &cobra.Command{
	Use:   "start",
	Short: "starts Artee VPN service",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel, false)
		if err != nil {
		...
		cmd.Println("Artee VPN service has been started")
		return nil
	},
}
...
var stopCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		cmd.Println("Artee VPN service has been stopped")
		return nil
	},
}
...
var restartCmd = &cobra.Command{
	Use:   "restart",
	Short: "restarts Artee VPN service",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		s, err := setupServiceControlCommand(cmd, ctx, cancel, false)
		if err != nil {
		...
		cmd.Println("Artee VPN service has been restarted")
		return nil
	},
}
...
var svcStatusCmd = &cobra.Command{
	Use:   "status",
	Short: "shows Artee VPN service status",
	RunE: func(cmd *cobra.Command, args []string) error {
		ctx, cancel := context.WithCancel(cmd.Context())
		...
		cmd.Printf("Artee VPN service status: %s\n", statusText)
		return nil
	},
}
