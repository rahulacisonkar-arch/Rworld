...
import (
	...
	"github.com/Artee VPNio/Artee VPN/upload-server/types"
...
var debugCmd = &cobra.Command{
	...
	Long:  "Commands for debugging and logging within the Artee VPN daemon.",
}

var debugBundleCmd = &cobra.Command{
	Use:     "bundle",
	Example: "  Artee VPN debug bundle",
...
var logCmd = &cobra.Command{
	Use:   "log",
	Short: "Manage logging for the Artee VPN daemon",
	Long:  `Commands to manage logging settings for the Artee VPN daemon, including ICE, gRPC, and general log levels.`,
}
...
var forCmd = &cobra.Command{
	...
	Example: "  Artee VPN debug for 5m",
	Args:    cobra.ExactArgs(1),
	RunE:    runForDuration,
}
...
var persistenceCmd = &cobra.Command{
	...
	Example: "  Artee VPN debug persistence on",
	Args:    cobra.ExactArgs(1),
...
var debugConfigCmd = &cobra.Command{
	Use:     "config",
	Example: "  Artee VPN debug config",
...
// debugConfigDump implements `Artee VPN debug config`. It resolves the
...
func debugBundle(cmd *cobra.Command, _ []string) error {
	...
	request := &proto.DebugBundleRequest{
		...
		CliVersion:   version.Artee VPNVersion(),
	}
	if uploadBundleFlag {
...
func runForDuration(cmd *cobra.Command, args []string) error {
	...
	if needsRestoreUp {
		if _, err := client.Up(cmd.Context(), &proto.UpRequest{}); err != nil {
			...
			cmd.Println("Artee VPN up (restored)")
		}
	}
...
func generateDebugBundle(config *profilemanager.Config, recorder *peer.Status, connectClient *internal.ConnectClient, logFilePath string) {
	...
	bundleGenerator := debug.NewBundleGenerator(
		debug.GeneratorDependencies{
			...
			LogPath:        logFilePath,
			CPUProfile:     nil,
			DaemonVersion:  version.Artee VPNVersion(), // acting as daemon
		},
		debug.BundleConfig{
