...
Examples:
  Artee VPN debug capture
  Artee VPN debug capture host 100.64.0.1 and port 443
  Artee VPN debug capture tcp
  Artee VPN debug capture icmp
  Artee VPN debug capture src host 10.0.0.1 and dst port 80
  Artee VPN debug capture -o capture.pcap
  Artee VPN debug capture --pcap | tshark -r -
  Artee VPN debug capture --pcap | tcpdump -r - -n`,
