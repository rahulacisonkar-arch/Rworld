...
var networksCMD = &cobra.Command{
	...
	Short:   "Manage connections to Artee VPN Networks and Resources",
...
var routesListCmd = &cobra.Command{
	...
	Aliases: []string{"ls"},
	Short:   "List networks",
	Example: "  Artee VPN networks list",
...
var routesSelectCmd = &cobra.Command{
	...
	Example: "  Artee VPN networks select all\n  Artee VPN networks select route1 route2\n  Artee VPN routes select -a route3",
...
var routesDeselectCmd = &cobra.Command{
	...
	Example: "  Artee VPN networks deselect all\n  Artee VPN networks deselect route1 route2",
	Args:    cobra.MinimumNArgs(1),
