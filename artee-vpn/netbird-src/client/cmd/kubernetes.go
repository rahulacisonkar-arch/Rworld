...
const (
	KubernetesDNSSuffix = "Artee VPN-kubeapi-proxy"
)
...
var kubernetesListCmd = &cobra.Command{
	...
	Long:  "List Kubernetes clusters by discovering Artee VPN peers running Artee VPN-kubeapi-proxy.",
}
...
var kubernetesWriteKubeconfigCmd = &cobra.Command{
	...
	Long:  "Updates kubeconfig in place to allow token-less access to the Kubernetes cluster through Artee VPN.",
}
