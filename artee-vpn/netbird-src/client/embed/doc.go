// Package embed provides a way to embed the Artee VPN client directly
// into Go programs without requiring a separate Artee VPN client installation.
package embed
...
//	    client, err := Artee VPN.New(Artee VPN.Options{
...
//	        fmt.Fprintf(w, "Hello from Artee VPN!")
//	    })
//
//	    // Listen on Artee VPN network
...
//	    }()
//
//	    log.Printf("HTTP server listening on Artee VPN network port 8080")
//
//	    // Handle shutdown
...
//	        log.Printf("Artee VPN shutdown error: %v", err)
//	    }
//	}
//
...
//	    }
//
//	    // Create HTTP client that uses Artee VPN network
//	    httpClient := client.NewHTTPClient()
//	    httpClient.Timeout = 10 * time.Second
//
//	    // Make request to server in Artee VPN network
