...
func (c *CombinedConfig) applyManagementDefaults(exposedHost string) {
	...
	if c.Management.DataDir == "" || c.Management.DataDir == "/var/lib/Artee VPN/" {
...
// Returns just the host:port (e.g., "selfhosted2.demo.Artee VPN.io:443").
...
func (c *CombinedConfig) ToManagementConfig() (*nbconfig.Config, error) {
	...
	httpConfig.AuthAudience = "Artee VPN-dashboard"
	httpConfig.AuthClientID = httpConfig.AuthAudience
	httpConfig.CLIAuthAudience = "Artee VPN-cli"
