...
import (
	...
	"github.com/Artee VPNio/Artee VPN/relay/healthcheck"
	relayServer "github.com/Artee VPNio/Artee VPN/relay/server"
	"github.com/Artee VPNio/Artee VPN/relay/server/listener"
	"github.com/Artee VPNio/Artee VPN/relay/server/listener/ws"
	sharedMetrics "github.com/Artee VPNio/Artee VPN/shared/metrics"
	"github.com/Artee VPNio/Artee VPN/shared/relay/auth"
	"github.com/Artee VPNio/Artee VPN/shared/signal/proto"
	signalServer "github.com/Artee VPNio/Artee VPN/signal/server"
	"github.com/Artee VPNio/Artee VPN/stun"
	"github.com/Artee VPNio/Artee VPN/util"
	"github.com/Artee VPNio/Artee VPN/util/wsproxy"
	wsproxyserver "github.com/Artee VPNio/Artee VPN/util/wsproxy/server"
)
...
var (
	...
	rootCmd = &cobra.Command{
		Use:   "combined",
		Short: "Combined Artee VPN server (Management + Signal + Relay + STUN)",
		Long: `Combined Artee VPN server for self-hosted deployments.
...
func initializeConfig() error {
	...
	log.Infof("Starting combined Artee VPN server")
	logConfig(config)
	logEnvVars()
	return nil
}
