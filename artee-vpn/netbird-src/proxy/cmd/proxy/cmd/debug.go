...
Examples:
  Artee VPN-proxy debug capture <account-id>
  Artee VPN-proxy debug capture <account-id> --duration 1m host 10.0.0.1
  Artee VPN-proxy debug capture <account-id> host 10.0.0.1 and tcp port 443
  Artee VPN-proxy debug capture <account-id> not port 22
  Artee VPN-proxy debug capture <account-id> -o capture.pcap
  Artee VPN-proxy debug capture <account-id> --pcap | tcpdump -r - -n
  Artee VPN-proxy debug capture <account-id> --pcap | tshark -r -`,
