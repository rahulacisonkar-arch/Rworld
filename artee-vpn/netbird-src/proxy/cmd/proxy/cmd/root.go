...
import (
	...
	"github.com/Artee VPNio/Artee VPN/proxy"
	nbacme "github.com/Artee VPNio/Artee VPN/proxy/internal/acme"
...
const DefaultManagementURL = "https://api.Artee VPN.io:443"
...
var rootCmd = &cobra.Command{
	Use:          "proxy",
	Short:        "Artee VPN reverse proxy server",
	Long:         "Artee VPN reverse proxy server for proxying traffic to Artee VPN networks.",
	Version:      Version,
	SilenceUsage: true,
	RunE:         runServer,
}
...
func init() {
	...
	rootCmd.Flags().StringVar(&proxyDomain, "domain", envStringOrDefault("NB_PROXY_DOMAIN", ""), "The Domain at which this proxy will be reached. e.g., Artee VPN.example.com")
	...
	rootCmd.Flags().BoolVar(&private, "private", envBoolOrDefault("NB_PROXY_PRIVATE", false), "Enable private services accessible with Artee VPN-Only authentication mode.")
	...
	rootCmd.Flags().StringVar(&geoDataDir, "geo-data-dir", envStringOrDefault("NB_PROXY_GEO_DATA_DIR", "/var/lib/Artee VPN/geolocation"), "Directory for the GeoLite2 MMDB file (auto-downloaded if missing)")
