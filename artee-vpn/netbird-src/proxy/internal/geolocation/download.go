...
const (
	mmdbTarGZURL  = "https://pkgs.Artee VPN.io/geolocation-dbs/GeoLite2-City/download?suffix=tar.gz"
	mmdbSha256URL = "https://pkgs.Artee VPN.io/geolocation-dbs/GeoLite2-City/download?suffix=tar.gz.sha256"
...
// it downloads from pkgs.Artee VPN.io with SHA256 verification.
func ensureMMDB(logger *log.Logger, dataDir string) (string, error) {
	...
	logger.Info("geolocation database not found, downloading from pkgs.Artee VPN.io")
