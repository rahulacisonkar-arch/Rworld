...
// mockArtee VPN creates a Artee VPN instance for testing without actually connecting.
// It uses an invalid management URL to prevent real connections.
func mockArtee VPN() *Artee VPN {
	nb := NewArtee VPN(context.Background(), "test-proxy", "invalid.test", ClientConfig{
...
func TestArtee VPN_AddPeer_CreatesClientForNewAccount(t *testing.T) {
	nb := mockArtee VPN()
...
func TestArtee VPN_AddPeer_ReuseClientForSameAccount(t *testing.T) {
	nb := mockArtee VPN()
	accountID := types.AccountID("account-1")
...
func TestArtee VPN_AddPeer_SeparateClientsForDifferentAccounts(t *testing.T) {
	nb := mockArtee VPN()
...
func TestArtee VPN_RemovePeer_KeepsClientWhenServicesRemain(t *testing.T) {
	nb := mockArtee VPN()
	accountID := types.AccountID("account-1")
...
func TestArtee VPN_RemovePeer_RemovesClientWhenLastServiceRemoved(t *testing.T) {
	nb := mockArtee VPN()
	accountID := types.AccountID("account-1")
...
func TestArtee VPN_RemovePeer_NonExistentAccountIsNoop(t *testing.T) {
	nb := mockArtee VPN()
...
func TestArtee VPN_RemovePeer_NonExistentServiceIsNoop(t *testing.T) {
	nb := mockArtee VPN()
	accountID := types.AccountID("account-1")
...
func TestArtee VPN_StopAll_StopsAllClients(t *testing.T) {
	nb := mockArtee VPN()
	account1 := types.AccountID("account-1")
	account2 := types.AccountID("account-2")
...
func TestArtee VPN_ClientCount(t *testing.T) {
	nb := mockArtee VPN()
...
func TestArtee VPN_RoundTrip_RequiresAccountIDInContext(t *testing.T) {
	nb := mockArtee VPN()
...
func TestArtee VPN_RoundTrip_RequiresExistingClient(t *testing.T) {
	nb := mockArtee VPN()
	accountID := types.AccountID("nonexistent-account")
...
func TestArtee VPN_AddPeer_ExistingStartedClient_NotifiesStatus(t *testing.T) {
...
// TestArtee VPN_IdentityForIP_UnknownAccountReturnsFalse confirms that the
...
func TestArtee VPN_IdentityForIP_UnknownAccountReturnsFalse(t *testing.T) {
	nb := mockArtee VPN()
...
func TestArtee VPN_RemovePeer_NotifiesDisconnection(t *testing.T) {
	notifier := &mockStatusNotifier{}
	nb := NewArtee VPN(context.Background(), "test-proxy", "invalid.test", ClientConfig{
		MgmtAddr:     "http://invalid.test:9999",
		WGPort:       0,
...
// TestArtee VPN_RemovePeer_TeardownIsAsync proves the fix for the receive-loop
...
func TestArtee VPN_RemovePeer_TeardownIsAsync(t *testing.T) {
	nb := NewArtee VPN(context.Background(), "test-proxy", "invalid.test", ClientConfig{
		MgmtAddr: "http://invalid.test:9999",
...
// TestArtee VPN_AddPeer_WaitsForTeardown proves the lifecycle lock serialises a
...
func TestArtee VPN_AddPeer_WaitsForTeardown(t *testing.T) {
	nb := NewArtee VPN(context.Background(), "test-proxy", "invalid.test", ClientConfig{
		MgmtAddr: "http://invalid.test:9999",
	}, nil, &mockStatusNotifier{}, &mockMgmtClient{})
	nb.startClient = func(types.AccountID, *embed.Client) {}
