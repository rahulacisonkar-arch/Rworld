...
var (
	...
	runCmd = &cobra.Command{
		Use:          "run",
		Short:        "start Artee VPN Signal Server daemon",
		SilenceUsage: true,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			log.Infof("signal server version %s", version.Artee VPNVersion())
