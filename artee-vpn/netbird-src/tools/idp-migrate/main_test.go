...
import (
	...
	"github.com/Artee VPNio/Artee VPN/management/server/idp/migration"
)
...
func TestValidateConfig(t *testing.T) {
	valid := &migrationConfig{
		configPath:   "/etc/Artee VPN/management.json",
...
func TestConfigFromArgs_EnvVarsApplied(t *testing.T) {
	t.Run("env vars fill in for missing flags", func(t *testing.T) {
		t.Setenv("Artee VPN_CONFIG_PATH", "/env/management.json")
		t.Setenv("Artee VPN_DATA_DIR", "/env/data")
		t.Setenv("Artee VPN_IDP_SEED_INFO", "env-seed")
		t.Setenv("Artee VPN_API_URL", "https://api.env.com")
		t.Setenv("Artee VPN_DASHBOARD_URL", "https://dash.env.com")
...
func TestApplyOverrides_MostGranularWins(t *testing.T) {
	...
	t.Run("Artee VPN_DOMAIN overrides flags", func(t *testing.T) {
		cfg := &migrationConfig{
			apiURL:       "api.flag.com",
			dashboardURL: "dash.flag.com",
		}
		t.Setenv("Artee VPN_DOMAIN", "env-broad.com")
	...
	t.Run("specific env vars beat Artee VPN_DOMAIN", func(t *testing.T) {
		cfg := &migrationConfig{}
		t.Setenv("Artee VPN_DOMAIN", "env-broad.com")
		t.Setenv("Artee VPN_API_URL", "api.env-specific.com")
		t.Setenv("Artee VPN_DASHBOARD_URL", "dash.env-specific.com")
	...
	t.Run("specific env vars beat all flags combined", func(t *testing.T) {
		...
		t.Setenv("Artee VPN_API_URL", "api.env.com")
		t.Setenv("Artee VPN_DASHBOARD_URL", "dash.env.com")
	...
	t.Run("env vars override all non-domain flags", func(t *testing.T) {
		...
		t.Setenv("Artee VPN_CONFIG_PATH", "/env/path")
		t.Setenv("Artee VPN_DATA_DIR", "/env/data")
		t.Setenv("Artee VPN_IDP_SEED_INFO", "env-seed")
		t.Setenv("Artee VPN_DRY_RUN", "true")
		t.Setenv("Artee VPN_FORCE", "true")
		t.Setenv("Artee VPN_SKIP_CONFIG", "true")
		t.Setenv("Artee VPN_SKIP_POPULATE_USER_INFO", "true")
		t.Setenv("Artee VPN_LOG_LEVEL", "debug")
	...
	t.Run("boolean env vars properly parse false values", func(t *testing.T) {
		cfg := &migrationConfig{}
		t.Setenv("Artee VPN_DRY_RUN", "false")
		t.Setenv("Artee VPN_FORCE", "yes")
		t.Setenv("Artee VPN_SKIP_CONFIG", "0")
  ...
  "IdpManagerConfig": {
    ...
    "ClientConfig": {
      ...
      "ClientSecret": "zit-secret"
		...
		assert.Equal(t, "/var/lib/Artee VPN", result["Datadir"])
	})
